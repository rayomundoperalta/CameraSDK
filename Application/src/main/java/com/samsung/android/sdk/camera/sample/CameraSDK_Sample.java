...
import com.samsung.android.sdk.camera.sample.cases.Sample_Gif;
import com.samsung.android.sdk.camera.sample.cases.Sample_HDR;
import com.samsung.android.sdk.camera.sample.cases.Sample_HazeRemove;
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (SAMPLE_NAMES_LIST[position]) {
                    ...
                    case SAMPLE_HAZE: {
                        Intent intent = new Intent(CameraSDK_Sample.this, Sample_HazeRemove.class);
                        startActivity(intent);
                        break;
                    }

                    case SAMPLE_GIF: {
                        Intent intent = new Intent(CameraSDK_Sample.this, Sample_Gif.class);
                        startActivity(intent);
                        break;
                    }
